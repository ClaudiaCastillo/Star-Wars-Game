...
$(document).ready(function () {
    ...
    // Create Character object to hold the game characters.
    ...
    var characters = {
        "Anakin Skywalker": {
            ...
            health: 120,
            attack: 8,
            imageUrl: "assets/images/anakin_skywalker.jpg",
            enemyAttackBack: 15
        },
        "Darth Vader": {
            name: "Darth Vader",
        ...
        "Kylo Ren": {
            ...
            health: 150,
            attack: 8,
            imageUrl: "assets/images/kylo_ren.png",
            enemyAttackBack: 20
        },
        "Luke Skywalker": {
            name: "Luke Skywalker",
    ...
    $("#attack-button").on("click", function () {
        ...
        // If there is no defender, render an error message.
            ...
            clearMessage();
            renderMessage("Attack button only works when there is a Defender.");
        }
    });
